...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener{
            ...
            if (yes.isChecked && name.text.isEmpty() || lastname.text.isEmpty() || feedback.text.isEmpty()) {
                Toast.makeText(this, "გთხოვთ უპასუხეთ ორივე შეკითხვას", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
            else if(no.isChecked && name.text.isEmpty() || lastname.text.isEmpty() || feedback.text.isEmpty()){
                Toast.makeText(this, "გთხოვთ უპასუხეთ ორივე შეკითხვას", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
